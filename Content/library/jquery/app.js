...
(function($, window, document){
  ...
  $(window).load(function() {
    ...
    $('.scroll-content-itemSelected').slimScroll({
        height: '150px'
    });
    $('.scroll-content-DetailGroup').slimScroll({
        height: '150px'
    });
    $('.scroll-content-discount').slimScroll({
        height: '376px'
    });
    $('.scroll-content-item').slimScroll({
        height: '236px'
    });
    $('.scroll-content-split').slimScroll({
        height: '175px'
    });
    $('.scroll-content-toMerge').slimScroll({
        height: '300px'
    });
    $('.scrool-report-group').slimScroll({
        height: '300px'
    });
