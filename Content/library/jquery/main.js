...
var Main = function () {
    ...
    //function to text scroll company
    var runTextCompanyScroll = function () { }
    var marquee = $('div.profile');
    marquee.each(function () {
        var mar = $(this), indent = mar.width();
        mar.marquee = function () {
            indent--;
            mar.css('text-indent', indent);
            if (indent < -1 * mar.children('div.profile-text').width()) {
                indent = mar.width();
            }
        };
